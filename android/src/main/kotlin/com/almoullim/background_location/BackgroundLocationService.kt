...
class BackgroundLocationService : MethodChannel.MethodCallHandler, EventChannel.StreamHandler,
    ...
    companion object {
        const val METHOD_CHANNEL_NAME = "${BackgroundLocationPlugin.PLUGIN_ID}/background_location"
        const val EVENT_CHANNEL_NAME = "${BackgroundLocationPlugin.PLUGIN_ID}/background_location_stream"
